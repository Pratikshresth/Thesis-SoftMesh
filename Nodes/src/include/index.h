...
<html>
    <head>
        ...
        <title>Soft Mesh Network Portal</title>
        <meta name="description" content="Mesh Network Pratik Shrestha">
    ...
    <body>
        ...
        <h2 class="">You are Connected to Soft Mesh Network</h2>
        <div class="content main" id="formContent">
            <h3>Fill out the form below to submit information to the  network.</h3>
            <div id="form">
                <form>
                ...
                <h6 style="font-size: 10px; text-align: center;margin-top: 24px;">Powered by the Soft Mesh Network</h6>
            </div>
        </div>
